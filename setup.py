# -*- coding: utf-8 -*-
"""Installer for the collective.volto.otp package."""
...
setup(
    ...
    version="1.0a1",
    description="otp validator for emails",
    ...
    url="https://github.com/collective/collective.volto.otp",
    project_urls={
        ...
        # 'Documentation': 'https://collective.volto.otp.readthedocs.io/en/latest/',
    },
    ...
    target = plone
    [console_scripts]
    update_locale = collective.volto.otp.locales.update:update_locale
    """,
)
